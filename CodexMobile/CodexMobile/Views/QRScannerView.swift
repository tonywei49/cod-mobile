        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                if let command = prompt.command, !command.isEmpty {
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Gogodex", detail: "Install the latest Gogodex build on this iPhone.")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        ...
        message: "This QR code was generated by a different Gogodex npm version. Update the package on your computer to the latest release before scanning a new QR code.",
